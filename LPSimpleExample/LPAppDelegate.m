...
{
    NSURL *defaultsURL = [[NSBundle mainBundle] URLForResource:@"calabashDefaults" withExtension:@"plist"];
    NSDictionary *defaults = [NSDictionary dictionaryWithContentsOfURL:defaultsURL];
    [[NSUserDefaults standardUserDefaults] registerDefaults:defaults];
    
    [[NSUserDefaults standardUserDefaults] setInteger:0 forKey:@"NOTIFICATION_PRESENTED"];
}
